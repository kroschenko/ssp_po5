...
public final class Library extends PublicBuilding {
    ...
    public Library(final String c_Name, final String c_Address) {
        super(c_Name, c_Address);
    }

    public Library(final String c_Name, final String c_Address, final Integer c_VisitorsCount) {
    ...
    public Library(final String c_Name, final String c_Address, final Catalog c_Catalog) {
        super(c_Name, c_Address);
        this.m_Catalog = c_Catalog;
    }

    public Library(final String c_Name, final String c_Address, final Catalog c_Catalog,
            final Set<Administrator> c_Administrators) {
        super(c_Name, c_Address);
        this.m_Catalog = c_Catalog;
    ...
    public Library(final String c_Name, final String c_Address, final Catalog c_Catalog,
            final Set<Administrator> c_Administrators, final Set<Librarian> c_Librarians) {
        super(c_Name, c_Address);
        this.m_Catalog = c_Catalog;
        this.m_Administrators = c_Administrators;
    ...
    public Library(final String c_Name, final String c_Address, final Catalog c_Catalog,
            final Set<Administrator> c_Administrators, final Set<Librarian> c_Librarians, final Set<Reader> c_Readers) {
        super(c_Name, c_Address);
        this.m_Catalog = c_Catalog;
        this.m_Administrators = c_Administrators;
        this.m_Librarians = c_Librarians;
    ...
    public Library(final String c_Name, final String c_Address, final Catalog c_Catalog,
            final Set<Administrator> c_Administrators, final Set<Librarian> c_Librarians, final Set<Reader> c_Readers,
            final Set<Reader> c_BlackList, final Set<Order> c_Orders) {
        super(c_Name, c_Address);
        this.m_Catalog = c_Catalog;
        this.m_Administrators = c_Administrators;
        this.m_Librarians = c_Librarians;
