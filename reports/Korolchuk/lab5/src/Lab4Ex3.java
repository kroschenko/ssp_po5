...
abstract class Dispatcher {
    ...
    public static void constructor(Trip[] trips, Driver[] drivers, Car[] cars) {
        Dispatcher.trips = new ArrayList<>(Arrays.asList(trips));
        Dispatcher.drivers = new ArrayList<>(Arrays.asList(drivers));
        Dispatcher.cars = new ArrayList<>(Arrays.asList(cars));
    }
    ...
    public static void scheduleTrips() {
        point1:
        for (Trip trip : trips) {
            point2:
            if (!trip.scheduled) {
