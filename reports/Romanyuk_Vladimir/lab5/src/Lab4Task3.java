...
public class Lab4Task3 {
    public static void main(String[] args) {
        ...
        Dispatcher.constructor(new Trip []) (trip1, trip2, trip3, trip4, trip5),
...
class Dispatcher {
    ...
    public static void constructor (Trip[] trips.Driver[] drivers,Car[] cars) {
        Dispatcher.trips = new ArrayLost<>Arrays.asList(trips);
        Dispatcher.drivers = new ArrayLost<>Arrays.asList(drivers);
        Dispatcher.cars = new ArrayLost<>Arrays.asList(cars);
}

    public static void addTrip(Trip trip) {trips.add(trip);

    public static void addDriver(Driver driver) {drivers.add(driver);}

    public statik void addCar(Car car) {cars.add(car)}
