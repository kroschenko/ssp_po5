...
public class TimeTableAddingDialog {
    Label tittleLabel;
    Button addButton;
    ...
    public TimeTableAddingDialog(Stage primaryStage) {
        initControls();
        ...
        addButton.setOnAction(event -> {
            ...
            try {
                DBManager repositoryManager = new DBManager();
                repositoryManager.scheduleTable.Add(new TimeTable(groupId, subjectId, lecturerId, weekDay, calendarId));
                newWindow.close();
            }
            catch (SQLException throwables) {
                throwables.printStackTrace();
